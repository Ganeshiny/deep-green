...
def main():
    ...
    parser.add_argument('--model_path', type=str, default='/home/hpc_users/2019s17273@stu.cmb.ac.lk/ganeshiny/protein-go-predictor/model_and_weight_files/WEIGHTS_2LAYERS.pth')
